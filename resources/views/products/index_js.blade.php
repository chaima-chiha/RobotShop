            ...
            <div class="rounded position-relative fruite-item p-4 border border-secondary rounded-bottom">
                <div class="fruite-img">
                    <img src="${product.image ? '/storage/' + product.image : '/images/default.png'}"
                        class="img-fluid w-100 rounded-top" loading="lazy" alt="${product.name}">
                </div>
                ...
                <div class="fruite-content">
                    ...
                    <div class="buttons">
                        <a href="/products/${product.id}" class="btn btn-success rounded-pill">Voir les détails</a>
                        <button class="add-to-cart-btn btn border border-secondary rounded-pill text-primary fa fa-shopping-bag me-2"
                            data-product-id="${product.id}">Ajouter au panier</button>
                    </div>
                </div>
            </div>
        </div>
